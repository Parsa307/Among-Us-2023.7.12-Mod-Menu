...
bool UnlockAll = false, FakeBan = false;
float LightRadius = 0;
void *instanceBtn;
...
bool (*old_fakeban)(void *instance);
bool fakeban(void *instance) {
    if (instance != NULL && FakeBan) {
        return true;
    }
    return old_fakeban(instance);
}
...
HOOK_LIB("libil2cpp.so", "0x1216EE0,", unlockall, old_unlockall);
HOOK_LIB("libil2cpp.so", "0x1217070,", unlockall, old_unlockall);
HOOK_LIB("libil2cpp.so", "0x123B6F0,", lightradius, old_lightradius);
HOOK_LIB("libil2cpp.so", "0x13D3F04,", fakeban, old_fakeban);
...
jobjectArray GetFeatureList(JNIEnv *env, jobject context) {
    ...
    const char *features[] = {
        OBFUSCATE("Category_Mods"),
        OBFUSCATE("10_Toggle_Unlock All"),
        OBFUSCATE("15_Toggle_Fake Ban"),
        OBFUSCATE("20_SeekBar_Light Radius_1_20"),
        OBFUSCATE("ButtonLink_Youtube Channel_https://youtube.com/@Parsast1000")
    };
...
void Changes(JNIEnv *env, jclass clazz, jobject obj,
    ...
    switch (featNum) {
        case 10:
            UnlockAll = boolean;
             if (boolean) {
                Toast(env,obj,OBFUSCATE("Unlock All Enabled"),ToastLength::LENGTH_SHORT);
                }
           break;
           case 15:
               FakeBan = boolean;
            if (boolean) {
                Toast(env,obj,OBFUSCATE("Fake Ban Enabled"),ToastLength::LENGTH_SHORT);
            }
            break;
        case 20:
            LightRadius = value;
        ...
        /*case 1:
             if (boolean) {
                Toast(env,ctx,OBFUSCATE("Unlock Pets Enabled"),ToastLength::LENGTH_SHORT);
                }
