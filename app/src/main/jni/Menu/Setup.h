...
void Init(JNIEnv *env, jobject thiz, jobject ctx, jobject title, jobject subtitle){
    //Set sub title
    setText(env, title, OBFUSCATE("<b>Modded by Parsast</b>"));

    //Set sub title
    setText(env, subtitle, OBFUSCATE("<b>Among Us 2023.7.12 Please Subscribe To My Channel</b>"));

    //Dialog Example
    //setDialog(ctx,env,OBFUSCATE("Title"),OBFUSCATE("Message Example"));

    //Toast Example
    Toast(env,ctx,OBFUSCATE("Modded by Parsast"),ToastLength::LENGTH_LONG);
